...
var Layout = function () {
    ...
    var handleSidebarMenuActiveLink = function (mode, el, u) {
        //var url = location.hash.toLowerCase();        
        var url = u || location.hash.toLowerCase();
    ...
    var handleSidebarMenu = function (){
        ...
        $('body').on('click', '.page-sidebar li > a', function (e){alert('hehe');
        /*$('.page-sidebar').on('click', 'li > a', function (e) {alert('hehe');*/
    ...
    return {
        ...
        initSidebarMenuActive: function (url) {
            handleSidebarMenuActiveLink('match', null, url); // init sidebar active links 
        },
